...
namespace HKSecondQuest
{
    internal class GeneralChanges
    {
        public static void ChangeText()
        {
            ...
            //stag dialog
            ReplaceText("STAG_MEET", "You called, traveler? How unusual, these days. But maybe this is a sign of better times. May I see your ticket, please?");
            ...
            ReplaceText("INV_DESC_TRINKET3", "A statue of the Glimmering King. The guy seems to have an usual taste in hats.");
