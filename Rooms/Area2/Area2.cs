...
namespace HKSecondQuest.Rooms.Area2
{
    internal class Area2 : Room
    {
        ...
        public override void OnInit()
        {
            ...
            ReplaceText("GREEN_TABLET_07", "Keep of the pasture. It's full of durandoo dung.");
            ReplaceText("GREEN_TABLET_02", "Elderly mossnight seeks Vengefly with bush trimming experience.<page>Paid in exposure.");
