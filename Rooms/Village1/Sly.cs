...
namespace HKSecondQuest.Rooms.Village1
{
    internal class Sly : Room
    {
        ...
        public override void OnInit()
        {
            ...
            ReplaceText("SLY_MAPPER", "Ah, the old stag station is getting back up and running? I used to take it all the way up to the City three times a week, to resupply. But those days have long passe.");
        ...
        public override void OnWorldInit()
        {
            ...
            SetItem(LocationNames.Sly, ItemNames.Rancid_Egg, true, 110, alternateDesc: "A foul smelling egg. Said to be a delicacy from a far away kingdom.");
