...
namespace HKSecondQuest.Rooms.Village1
{
    internal class Village1 : Room
    {
        ...
        public override void OnInit()
        {
            ...
            ReplaceText("ELDERBUG_GOSSIP_HINT", "The realms roads have become treacherous in recent years.<br>You'd be well advised to always carry that little sword of yours close at hand.");
            ...
            ReplaceText("WITCH_INTRO", "Huuuh! A small shiny creature! I have a magic chest of dreams! Want to take a peek?");
